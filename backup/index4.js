//5/25/2023 codigo si queues en mqtt
...
function subscribeToTopics() {
  client.subscribe('ELP/Returns/PROXY/SickClarify/DDATA');
  client.subscribe('ELP/Returns/PROXY/Keyence/DDATA');
  client.subscribe('ELP/Returns/PROXY/Receiver_Sorter/DDATA');
  client.subscribe('ELP/QRA/+/DDATA');
}
